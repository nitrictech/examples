...
This is a [Nitric](https://nitric.io) Dart project, but Nitric is a framework for rapid development of cloud-native and serverless applications in many languages.
...
You can learn about the tools and techniques for Dart and Flutter in the [official Dart docs](https://dart.dev/tools).
