...
Simple & secure direct-to-bucket (e.g. S3) file uploads from modern browsers with signed URLs using the [Fastify framework](https://fastify.dev) for APIs and the Nitric SDK for bucket and file access.
